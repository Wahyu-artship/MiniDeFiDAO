...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface MyTimelockInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'updateDelay', data: BytesLike): Result;
  ...
  export interface MyTimelock extends BaseContract {
    
    connect(runner?: ContractRunner | null): MyTimelock;
    waitForDeployment(): Promise<this>;

    interface: MyTimelockInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getOperationState: TypedContractMethod<
      [id: BytesLike, ],
      [bigint],
      'view'
    >
...
getFunction(nameOrSignature: 'getMinDelay'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getOperationState'): TypedContractMethod<
      [id: BytesLike, ],
      [bigint],
      'view'
    >;
